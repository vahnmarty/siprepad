		...
		<div style="margin-top:15px;">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="col-md-12 text-center" style="text-align: right!important"><a id="AcceptFirstSurvyModal" class='text-success  mt-3'> Please take our survey</a></div>
					...
					<div class="col-md-12 text-center" style="text-align: right!important"><a id="AcceptFirstSurvyModal" class='btext-success  mt-3'> Please take our survey</a></div>
					@endif
					@php
					getAcceptanceModal();
					@endphp
			...
			@if($student_accept_status =="payment_successful" && $ntfDetail->student_profile == App\Models\Application::STUDENT_ONE && $appStatus->s1_application_status == App\Models\Application::TYPE_ACCEPTED)
			<!-- <div class="col-md-12 text-center" style="text-align: right!important"><a data-bs-toggle="modal" id="AcceptFirstSurvyModal"  class='btn btn_accept btn-success  mt-3 btn-sm'> Please take our survey</a></div> -->
			<script>
...
<div class="home-wrap">
	...
	<div class="hme-inr" id='ntf-detail'>
		...
		<div style="margin-top:15px;">
			...
			<p>Ms. Kristy Cahill Jacobson ‘98<br />Director of Admissions</p>
			<p><span class="text-primary"><a data-bs-toggle="modal" data-bs-target="#exampleModal" class=" text-primary ">
						...
						<div class="modal-body">
							...
							<table class="items" width="100%" style="font-size: 12px; border-collapse: collapse;" cellpadding="8">
								<thead>
									...
									<tr>
										<td width="100%" style="text-align: left;">My sincere congratulations to <?php echo getStudentInformation($candidate, $studentJoinsDetail, "Student_First_Name"); ?> upon acceptance to the Class of 2027 of St. Ignatius College Preparatory!
										</td>
									</tr>
									<tr>
										<td width="100%" style="text-align: left;">Your financial aid has been approved. You will receive {Financial Aid Amount} a year for the next four years, for a total of
											{Total Financial Aid Amount}. Your registration fee for Freshman year will be {Registration Fee}
										</td>
									</tr>
									<tr>
										<td width="100%" style="text-align: left;">We look forward to partnering with you as we provide an exceptional Jesuit education in the next four years.
										</td>
									</tr>
								</thead>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					@if($candidate == App\Models\Application::STUDENT_S1)
					@if($appStatus->s1_candidate_status == App\Models\Application::CANDIDATE_NOT_DEFINED || $appStatus->s1_candidate_status == App\Models\Application::CANDIDATE_READ)
					<div class='student_btns' style=" float: right !important; display:none">
						<a data-bs-toggle="modal" data-bs-target="#acceptModel" class='btn btn_accept btn-success mt-3 btn-sm text-dark'>Enroll at SI</a>
						<a data-bs-toggle="modal" data-bs-target="#rejectModel" class='btn btn-sm btn-danger mt-3 text-dark'>Decline Acceptance at SI</a>
					</div>
					@else
					...
					<div class="col-md-12 text-center" style="text-align: right!important"></div>
					<div class="col-md-12 text-center" style="text-align: right!important"><a data-bs-toggle="modal" id="AcceptFirstSurvyModal" class='text-success  mt-3'> Please take our survey</a></div>
					<!-- <div class="col-md-12 text-center" style="text-align: right!important">Congratulations on enrolling as a student in the SI Class of 2027! Please check back here on Monday, March 27th for next steps and registration information.</div> -->
					@endif
					@php
					getAcceptanceModal();
							...
							<div class="hme-inr" id='ntf-detail'>
								...
								<div style="margin-top:15px;">
									...
									<div class="row">
										...
										<div class="col-md-6">
											@if($student_status == App\Models\Application::ACCEPTANCE_FINANCIAL_AID_NO && $ntfDetail->notification_type == App\Models\Notification::ACCEPTANCE_FINANCIAL_AID_NO)
											@if($candidate == App\Models\Application::STUDENT_S1)
											@if($appStatus->s1_candidate_status == App\Models\Application::CANDIDATE_NOT_DEFINED || $appStatus->s1_candidate_status == App\Models\Application::CANDIDATE_READ)
											<div class='student_btns' style=" float: right !important; display:none">
												<a data-bs-toggle="modal" data-bs-target="#acceptModel" class='btn btn_accept btn-success mt-3 btn-sm text-dark'>Enroll at SI</a>
					...
					<a data-bs-toggle="modal" data-bs-target="#rejectModel" class='btn btn-sm btn-danger mt-3 text-dark'>Decline Acceptance at SI</a>
											...
											<div class="modal fade" id="Survey" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															<a id="AcceptanceAtSI" class='btn btn_accept acceptanceAtSI'> Please take our survey</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="modal fade" id="SurveyDecline" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-footer">
															<a id="declineAcceptanceAtSI" class='btn btn_accept'>Please take our survey</a>
														</div>
													</div>
												</div>
											</div>
									...
									<script>
										$(document).ready(function() {
											...
											$('#AcceptFirstSurvyModal').on('click', function(e) {
												$('#acceptanceServModal').modal('show');
												$('#Survey').modal('hide');
											})
											$('#AcceptFirstSurvyModal').on('click', function(e) {
