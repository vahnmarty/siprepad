							...
							<div class="col-lg-6">
								<div class="form-group" style="display:flex">
									<input type="number" class="form-control"
										...
										name='physician_phone1'   value=""style="width:25%;margin-right:5px;" /> @error('physician_phone1')
									...
									<input type="number" class="form-control"
										name='physician_phone2'   value="" style="width:25%" />@error('physician_phone2')
									...
									<input type="number" class="form-control"
										...
										name='physician_phone3'   value="" style="width:25%;margin-left:5px;" /> @error('physician_phone3')
