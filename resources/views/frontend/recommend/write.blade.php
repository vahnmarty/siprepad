                        ...
                        <div class="form-wrap">
                            <form action="{{ route('written-recommendation-submit') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="yearStudent" oninput="this.value = Math.abs(this.value)"
                                        min="1" class="form-control" value="{{ old('yearStudent') }}" />
                                    @error('yearStudent')
                                        <span class="error error_text">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <div data-maxcount="150">
                                        <textarea name="recommen" class="word_count" id="write_recommendation_textarea">{{ old('recommen') }}</textarea>
                                        <p class="wrds">
