    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register.post') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" autofocus autocomplete="name" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="state" class="block mt-1 w-full" type="text" name="state" :value="old('state')" autofocus autocomplete="state" />
            </div>

            <div class="mt-4">
                <x-jet-label for="zipcode" value="{{ __('zipcode') }}" />
                <x-jet-input id="zipcode" class="block mt-1 w-full" type="text" name="zipcode" :value="old('zipcode')" autofocus autocomplete="zipcode" />
            </div>

            <div class="mt-4">
                <x-jet-label for="covid_document" value="{{ __('covid_document') }}" />
                <x-jet-input id="covid_document" class="block mt-1 w-full" type="file" name="covid_document"/>
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('login.get') }}">
