                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="student_box">
                                        ...
                                        <div class="student_box_text">
                                            ...
                                            @if ($student['Current_School_Not_Listed'])
                                                <p>{{ $student['Current_School_Not_Listed'] }}</p>
                                            @else
                                                <p>---</p>
                                            @endif
        ...
        <div class="student_detail_wrapper">
            <div class="form_student_details">
                ...
                @forelse ($parentInfo as $parentKey=>$parent)
                    {{-- {{ dd($parent) }} --}}
                    <div class="studentWise_details">
                        {{-- <h4 class="sub_heading">{{ $parent['parent_Type'] }}</h4> --}}
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="student_box">
                            ...
                            <div class="col-lg-8 col-md-12">
                                <div class="student_box">
                                    ...
                                    {{-- <div class="student_box_text">
                                        <ul>
                                            @if ($parent['Living_Situation'])
                                                @forelse ($parent['Living_Situation'] as $lskey => $value)
                                                    @php
                                                        $item = App\Models\LivingSituation::find($lskey);
                                                    @endphp
                                                    <li>{{ $item->name }}</li>
                                                @empty
                                                    <li>---</li>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="student_box">
                                        ...
                                        <div class="student_box_text">
                                            @if ($studentPS['Student_name'])
                                                <p>{{ $studentPS['Student_name'] }}</p>
                                            @else
                                                <p>---</p>
                                            @endif
                                        </div>
                ...
                <div class="form_seven_box">
                    <div class="studentWise_details">
                        ...
                        <div class="row">
                            ...
                            @if ($spiritualCommunityInfo['Religious_Studies_Classes'] == 'No' ||
                            ...
                            @if ($spiritualCommunityInfo['School_Liturgies'] == 'No' ||
                                    ...
                                    <div class="student_box">
                                        ...
                                        <div class="student_box_text">
                                            @if ($spiritualCommunityInfo['School_Liturgies_Explanation'])
                                                <p>{{ $spiritualCommunityInfo['School_Liturgies_Explanation'] }}</p>
                                            @else
                                                <p>---</p>
                                            @endif
                                        </div>
                            ...
                            @if ($spiritualCommunityInfo['Community_Service'] == 'No' ||
                                    ...
                                    <div class="student_box">
                                        ...
                                        <div class="student_box_text">
                                            @if ($spiritualCommunityInfo['Community_Service_Explanation'])
                                                <p>{{ $spiritualCommunityInfo['Community_Service_Explanation'] }}</p>
                                            @else
                                                <p>---</p>
                                            @endif
                                        </div>
