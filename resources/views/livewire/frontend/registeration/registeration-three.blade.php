...
<form wire:submit.prevent="SaveHealthInfo">
					...
					<div class="form-wrap">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<input type="text" class="form-control"
										wire:model='medical_insurance_company' />
							...
							<div class="col-lg-6">
								<div class="form-group">
									<input type="number" class="form-control"
										wire:model='medical_policy_number' />
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<input type="text" class="form-control"
										wire:model='physician_name' /> @error('physician_name')
									<p class="text-danger">{{$message}}</p>
									@enderror @error('live_with')
									<p class="text-danger">{{$message}}</p>
									@enderror
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<input type="text" class="form-control"
										wire:model='physician_phone' /> @error('physician_phone')
									<p class="text-danger">{{$message}}</p>
									@enderror @error('live_with')
									<p class="text-danger">{{$message}}</p>
									@enderror
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									<textarea rows="8" cols="10" maxlength="1000"
										wire:model='prescribed_medication'>
                                      </textarea>
